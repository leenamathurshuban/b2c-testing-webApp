...
const availableIssues = [
  ...
  "Activation Lock (iCloud Lock/Find My Mac)",
  "Charging Issues",
  "Battery Issues",
  "Storage HDD/SSD (Hard Drive) Issues",
  "LCD/Display/LCD issues",
  "Upgrades (Storage/Logic Board/Memory)",
  "Keyboard Issues",
  "Trackpad/Touchpad issues",
  "Malware/Spyware/Virus Issues",
  "Tune-Up and Speed Issues",
  "Sound issues (Speakers/Microphone)",
  "macOS issues (Update/Upgrade)",
  "GPU/Graphic Issues",
  ...
  "Port issues (MagSafe/USB/Audio Jack/HDMI/Thunderbolt)",
  "Calibration issues (Silicon Macs)",
  "Magic Keyboard or Mouse issues"
];
