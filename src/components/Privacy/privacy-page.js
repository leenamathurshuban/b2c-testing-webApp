          ...
          <Row className="justify-content-center">
            <Col md={10} lg={10}>
              ...
              <div className="privacy-box-ul mrt50">
                <h2>Last updated: April 05, 2022 </h2>
                <p>
                ...
                <ul>
                  <li>
                    <span>Account</span> means a unique account created for You
                    to access our Service or parts of our Service.
                  </li>
                  <li>
                    <span>Company</span> (referred to as either "the Company",
                    "We", "Us" or "Our" in this Agreement) refers to Apple Fix
                    Pros.
                  </li>
                  <li>
                    <span>Cookies</span>
                  ...
                  <li>
                    <span>Website</span>
                    refers to Apple Fix Pros, accessible from{" "}
              ...
              <div className="privacy-box-ul">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    objects?" available at https://helpx.adobe.com/
                    flash-player/kb/disable-local-shared-objects-
                    flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_o
                    bjects_
                  </li>
                  <li>
                    ...
                    deleted as soon as You close Your web browser. Learn more
                    about cookies:
                    <Link href="" className="" target="_blank">
              ...
              <div className="privacy-box-ul">
                ...
                <ul>
                  <li>
                    <span>To provide and maintain our Service, </span>including
                  ...
                  <li>
                    <span>For the performance</span>of a contract: the
              ...
              <div className="privacy-box-ul">
                ...
                <p>
                  By email{" "}
                  <Link href="mailto:info@applefixpros.com" className="">
                    info@applefixpros.com
                  </Link>
                </p>
                <p>
                  By calling us
